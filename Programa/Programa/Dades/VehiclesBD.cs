        ...
        internal class VehiclesBD
        {
            ...
            public void InsertarVehicleBDD(string matricula, string marca, string model, int kilometratge, DateTime anyFabriacio, string tipusMotor)
            {
                ...
                if (connection != null)
                {
                    ...
                    {
                        connection.Open();
                        string sql = "INSERT INTO Vehicles (matricula, marca, model, kilometratge, anyFabriacio, tipusMotor) VALUES (@matricula, @marca, @model, @kilometratge, @anyFabriacio, @tipusMotor)";
                        MySqlCommand sqlCommand = new MySqlCommand(sql, connection);
